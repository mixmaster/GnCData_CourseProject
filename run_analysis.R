...
x_train$Activity <- (merge(y_train, activity_labels, all=TRUE))$V2

## Test data set
names(x_test) <- features$V2
x_test$Subject <- subject_test$V1
x_test$Activity <- (merge(y_test, activity_labels, all=TRUE))$V2
...
selected_ds <- merged_ds[, c("Subject", "Activity", selected)]
